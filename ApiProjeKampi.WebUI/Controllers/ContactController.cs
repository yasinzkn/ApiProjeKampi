...
namespace ApiProjeKampi.WebUI.Controllers
{
    public class ContactController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7060/api/Contacts?id=" + id);
            return RedirectToAction("ContactList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7060/api/Contacts/GetContact?id=" + id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateContact(UpdateContactDto updateContactDto)
        {
            ...
            StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7060/api/Contacts/", stringContent);
            return RedirectToAction("ContactList");
        }
    }
}
